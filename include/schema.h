...
public:
    ...
    int validate(config* conf, std::list<result>* res = nullptr);
...
public:
    ...
    virtual int validate(value* val, std::list<schema::result>* res = nullptr);
};
...
public:
    ...
    int validate(value* val, std::list<schema::result>* res = nullptr) override;
